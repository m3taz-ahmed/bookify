...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl shadow-xl p-8 mb-8 text-white">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-6 md:mb-0">
                    ...
                    <p class="text-blue-100 max-w-2xl">Manage your appointments, view booking history, and schedule new services all in one place.</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <a href="{{ route('customer.bookings.create') }}" class="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
            ...
            <a href="{{ route('customer.bookings') }}" class="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                <div class="flex items-center mb-4">
            ...
            <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
                ...
                <button class="inline-flex items-center text-purple-600 font-medium">
                    Edit profile
                    <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 mb-8 border border-gray-100">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('customer.bookings') }}" class="text-blue-600 hover:text-blue-800 font-medium text-sm">View all</a>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                @foreach(\App\Models\Service::where('is_active', true)->limit(3)->get() as $service)
                    <div class="border border-gray-200 rounded-xl p-5 hover:border-blue-300 transition-colors duration-200">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('customer.bookings.create') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
                    View all services
                    <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
