...
<li>
    <div class="flex items-center">
        ...
        <a href="{{ url()->current() }}" class="ml-1 text-sm font-medium text-primary-700 hover:text-primary-900 md:ml-2 dark:text-primary-400 dark:hover:text-white">{{ __('website.check_in') }}</a>
    </div>
</li>
@endsection
