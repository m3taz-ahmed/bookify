            ...
            <nav class="bg-white shadow-sm border-b border-gray-200">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden md:ml-6 md:flex md:space-x-6">
                                ...
                                <a href="{{ route('customer.bookings') }}" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition-colors duration-200">
                                    <svg class="h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                                    </svg>
                                    My Bookings
                                </a>
                                <a href="{{ route('customer.bookings.create') }}" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition-colors duration-200">
                                    <svg class="h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="ml-3 relative">
                                <div class="flex items-center space-x-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium text-gray-700">{{ auth()->guard('customer')->user()->name }}</span>
                                    </div>
                                    <a href="{{ route('customer.logout') }}" 
                                       onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                       class="inline-flex items-center text-sm text-gray-700 hover:text-gray-900 transition-colors duration-200">
                ...
                <div class="md:hidden" id="mobile-menu">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <a href="{{ route('customer.bookings.create') }}" class="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
                            Book Appointment
                        </a>
                    </div>
                    <div class="pt-4 pb-3 border-t border-gray-200">
                        <div class="flex items-center px-4">
                            ...
                            <div class="ml-3">
                                <div class="text-base font-medium text-gray-800">{{ auth()->guard('customer')->user()->name }}</div>
                                <div class="text-sm font-medium text-gray-500">{{ auth()->guard('customer')->user()->email }}</div>
                            </div>
                        </div>
