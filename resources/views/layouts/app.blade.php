        ...
        <nav class="bg-white/95 backdrop-blur-md shadow-md border-b border-background-200 sticky top-0 z-50 transition-all duration-300">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="hidden lg:flex lg:items-center lg:space-x-1">
                        ...
                        <a href="{{ route('customer.bookings') }}" class="inline-flex items-center px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-primary-50 hover:text-primary-700 {{ request()->routeIs('customer.bookings', 'customer.bookings.edit') ? 'bg-primary-100 text-primary-700' : 'text-dark-600' }}">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                            </svg>
                            {{ __('website.my_bookings') }}
                        </a>
                        <a href="{{ route('customer.profile') }}" class="inline-flex items-center px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-primary-50 hover:text-primary-700 {{ request()->routeIs('customer.profile', 'customer.profile.edit') ? 'bg-primary-100 text-primary-700' : 'text-dark-600' }}">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm font-semibold text-dark-900">{{ auth()->guard('customer')->user()->name }}</span>
                                <span class="text-xs text-gray-500">{{ __('website.dashboard') }}</span>
                            </div>
                        </div>
            ...
            <div class="lg:hidden hidden border-t border-gray-200 bg-white" id="mobile-menu">
                <div class="px-4 pt-4 pb-3 space-y-1">
                    ...
                    <a href="{{ route('customer.bookings') }}" class="flex items-center px-4 py-3 rounded-lg text-base font-medium text-dark-600 hover:bg-primary-50 hover:text-primary-700 transition-all duration-200 {{ request()->routeIs('customer.bookings', 'customer.bookings.edit') ? 'bg-primary-100 text-primary-700' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                        </svg>
                        {{ __('website.my_bookings') }}
                    </a>
                    <a href="{{ route('customer.profile') }}" class="flex items-center px-4 py-3 rounded-lg text-base font-medium text-dark-600 hover:bg-primary-50 hover:text-primary-700 transition-all duration-200 {{ request()->routeIs('customer.profile', 'customer.profile.edit') ? 'bg-primary-100 text-primary-700' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                        </svg>
                        {{ __('website.profile') }}
                    ...
                    <div class="flex items-center px-4 py-3">
                        ...
                        <div class="flex flex-col">
                            <div class="text-base font-semibold text-dark-900">{{ auth()->guard('customer')->user()->name }}</div>
                            <div class="text-sm text-gray-500">{{ auth()->guard('customer')->user()->email }}</div>
                        </div>
                    </div>
                    <div class="border-t border-gray-200 my-2"></div>
