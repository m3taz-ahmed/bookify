        ...
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-4 xl:col-span-1">
                    <div class="flex items-center">
                        <a href="{{ route('booking-welcome') }}" class="flex items-center">
                            <img src="{{ asset('images/logo.svg') }}" alt="SkyBridge Logo" class="h-10 w-8 filter brightness-0 invert" style="filter: drop-shadow(0 0 2px rgba(0,0,0,0.5));">
                ...
                <div class="mt-8 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                    @isset($footerPages)
                        <x-footer-pages :pages="$footerPages" />
                    @else
                        <div class="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul class="mt-2 space-y-2">
                                    <li>
                                        <a href="#" class="text-sm text-dark-400 hover:text-primary-300">
                            ...
                            <div class="mt-6 md:mt-0">
                                ...
                                <ul class="mt-2 space-y-2">
                                    <li>
                                        <a href="{{ route('pages.show', 'about-us') }}" class="text-sm text-dark-400 hover:text-primary-300">
                                            {{ __('website.about') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('pages.show', 'contact-us') }}" class="text-sm text-dark-400 hover:text-primary-300">
                                            {{ __('website.contact_us') }}
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul class="mt-2 space-y-2">
                                    <li>
                                        <a href="{{ route('pages.show', 'privacy-policy') }}" class="text-sm text-dark-400 hover:text-primary-300">
                                            {{ __('website.privacy') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('pages.show', 'terms-and-conditions') }}" class="text-sm text-dark-400 hover:text-primary-300">
                                            {{ __('website.terms') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('pages.show', 'faq') }}" class="text-sm text-dark-400 hover:text-primary-300">
                                            {{ __('website.faq') }}
                                        </a>
                                    </li>
                                </ul>
            ...
            <div class="mt-8 border-t border-gray-700 pt-6">
                <p class="text-sm text-dark-400 xl:text-center">
