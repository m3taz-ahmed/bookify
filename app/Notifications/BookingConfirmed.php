...
class BookingConfirmed extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $firstService = $this->booking->items->first()?->service;
        $serviceName = $firstService ? ($firstService->name_en ?? $firstService->name) : 'Multiple Services';
    ...
    public function toMsegatSms(object $notifiable): string
    {
        ...
        if ($firstService) {
            $serviceName = app()->getLocale() === 'ar' ? ($firstService->name_ar ?? $firstService->name) : ($firstService->name_en ?? $firstService->name);
        }
